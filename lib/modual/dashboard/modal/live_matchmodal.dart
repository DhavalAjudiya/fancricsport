...
List<LiveMatchModal> LiveMatchModalFromJson(String str) =>
    List<LiveMatchModal>.from(json.decode(str).map((x) => LiveMatchModal.fromJson(x)));

String LiveMatchModalToJson(List<LiveMatchModal> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class LiveMatchModal {
  ...
  factory LiveMatchModal.fromJson(Map<String, dynamic> json) => LiveMatchModal(
        jsonruns: json["jsonruns"],
        jsondata: json["jsondata"] != null ? json["jsondata"] : null,
        title: json["Title"],
...
class LiveMatchJsonDataModal {
  Jsondata? jsondata;

  LiveMatchJsonDataModal({this.jsondata});

  LiveMatchJsonDataModal.fromJson(Map<String, dynamic> json) {
...
class LiveMatchJsonRunModal {
  Jsonruns? jsonruns;

  LiveMatchJsonRunModal({this.jsonruns});

  LiveMatchJsonRunModal.fromJson(Map<String, dynamic> json) {
