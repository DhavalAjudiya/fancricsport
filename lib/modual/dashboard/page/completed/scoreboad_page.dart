                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.separated(
                      shrinkWrap: true,
                      padding:
                          EdgeInsets.symmetric(vertical: SizeUtils.horizontalBlockSize * 5),
                      itemCount: matchController.teamAPlayersList.length,
                      itemBuilder: (context, index) {
                        final data = matchController.teamAPlayersList[index];
                        String c, b;
                        ...
                        return Container(
                          decoration: BoxDecoration(
                              ...
                              color: data.outby.toString() == "not out"
                          ...
                          child: Padding(
                            ...
                            child:
                              ...
                              imageLoader(
                                  ...
                                  r: 20,
                                  loaderImage: AssetsPath.errorImage,
                                  url: matchController.completedImage.value +
                                    ...
                                    data.outby.toString() == ""
                                        ...
                                        : RichText(
                                            text: TextSpan(
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text: data.outby.toString() == "not out"
                                                        ? ""
                                                        : data.outby.toString() == ""
                                                            ? ""
                                                            : "\nb",
                              ...
                              SizedBox(
                                ...
                                child: AppText(
                                  ...
                                  color: data.outby.toString() == "not out"
                                      ...
                                      : data.outby.toString() == ""
                                          ? AppColor.white
                                          : int.parse(data.runs.toString()) >= 100
                                              ? AppColor.linkBtn
                                              : int.parse(data.runs.toString()) >= 50
                      ...
                      separatorBuilder: (BuildContext context, int index) {
                        return Column(
                          children: [
                            ...
                            (index + 1) % 5 == 0 ? BannerAds(adSize: true) : const SizedBox(),
                            SizedBox(height: SizeUtils.horizontalBlockSize * 1.5),
                          ],
                        );
                      },
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.separated(
                      ...
                      padding:
                          EdgeInsets.symmetric(vertical: SizeUtils.horizontalBlockSize * 5),
                      itemCount: matchController.teamBPlayersList.length,
                      itemBuilder: (context, index) {
                        final data = matchController.teamBPlayersList[index];
                        String c, b;
                        c = data.outby.toString().split("b").first;
                        b = data.outby.toString().split("b").last;
                        return Container(
